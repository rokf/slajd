...
function capture.title(txt) return { type = "title", txt } end
function capture.font(txt) return { type = "font", txt } end
function capture.image(txt) return { type = "image", txt } end
function capture.text(txt) return { type = "text", txt } end
